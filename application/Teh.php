...
class Teh implements Minuman
{
    public function buat()
    {
        ...
        echo "aduk hingga gula larut dalam teh. ";
    }
    
    public function minum()
    {
        echo "Dapat diminum secara sedikit - sedikit atau langsung dihabiskan. ";
    }

    public function tambahEs()
    {
        echo "Tambahkan es batu untuk dinikmati secara digin. ";
    }
}